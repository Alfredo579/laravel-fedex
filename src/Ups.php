    ...
    public function shipping(ShippingRequest $shippingRequest): ShippingResponse
    {
        ...
        try {
            ...
            if (is_array($response->ShipmentResponse->ShipmentResults->PackageResults)) {
                ...
                file_put_contents( $shippingRequest->labelSaveLocation.$fileName , base64_decode($response->ShipmentResponse->ShipmentResults->PackageResults->ShippingLabel->GraphicImage));
